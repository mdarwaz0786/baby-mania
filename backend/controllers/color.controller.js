...
export const createColor = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ success: true, message: "color created successfully", color });
  } catch (error) {
    console.log("error while creating color:", error.message);
    return res
      .status(500)
      .json({ success: false, message: "error while creating color" });
  }
};
...
export const fetchAllColor = async (req, res) => {
  try {
    ...
    return res
      ...
      .json({
        success: true,
        messsage: "color fetched successfully",
        color,
        totalCount,
      });
  } catch (error) {
    ...
    return res
      .status(500)
      .json({ success: false, message: "error while fetching color" });
  }
};
...
export const fetchSingleColor = async (req, res) => {
  try {
    ...
    return res
      ...
      .json({
        success: true,
        message: "single color fetched successfully",
        color,
      });
  } catch (error) {
    ...
    return res
      .status(500)
      .json({ success: false, message: "error while fetching single color" });
  }
};
...
export const updateColor = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, message: "error while updating color" });
  }
};
...
export const deleteColor = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, message: "error while deleting color" });
  }
};
