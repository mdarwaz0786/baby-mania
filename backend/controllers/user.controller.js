...
export const loggedInUser = async (req, res) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: "error while fetching logged in user data",
    });
  }
};
...
export const fetchAllUser = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, message: "error while fetching user" });
  }
};
...
export const deleteUser = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ success: false, message: "error while deleting User" });
  }
};
