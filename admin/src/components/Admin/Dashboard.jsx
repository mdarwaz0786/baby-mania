...
const Dashboard = () => {
  ...
  return (
    <>
      <div
        id="top"
        className="sa-app__body px-2 px-lg-4"
          ...
          <div className="row g-4 g-xl-5">
            <div className="col-12 col-md-4 d-flex">
              <div className="card saw-indicator flex-grow-1">
                ...
                <div className="saw-indicator__body">
                  ...
                  <Link
                    to="/admin/product-list"
                    className="saw-indicator__caption"
                  >
                    Go To Product List
                  </Link>
                </div>
            ...
            <div className="col-12 col-md-4 d-flex">
              <div className="card saw-indicator flex-grow-1">
                ...
                <div className="saw-indicator__body">
                  <div className="saw-indicator__value">
                    {allData?.category}
                  </div>
                  <Link
                    to="/admin/category-list"
                  ...
                  <div className="sa-widget-header__actions">
                    <div className="dropdown">
                      ...
                      >
                        ...
                        <li>
                          <Link className="dropdown-item" to="/admin/add-color">
                            Color Add
                          </Link>
                        </li>
                      </ul>
                ...
                <div className="sa-widget-header saw-indicator__header">
                  ...
                  <div className="sa-widget-header__actions">
                    <div className="dropdown">
                      ...
                      >
                        <li>
                          <Link className="dropdown-item" to="/admin/size-list">
                            Size List
                          </Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link className="dropdown-item" to="/admin/add-size">
                            Size Add
                          </Link>
                        </li>
                      </ul>
            ...
            <div className="col-12 col-md-4 d-flex">
              <div className="card saw-indicator flex-grow-1">
                <div className="sa-widget-header saw-indicator__header">
                  <h2 className="sa-widget-header__title">
            ...
            <div className="col-12 col-md-4 d-flex">
              <div className="card saw-indicator flex-grow-1">
                <div className="sa-widget-header saw-indicator__header">
                  <h2 className="sa-widget-header__title">Total Coupon</h2>
                  <div className="sa-widget-header__actions">
                    <div className="dropdown">
                      <button
                        type="button"
                ...
                <div className="saw-indicator__body">
                  <div className="saw-indicator__value">{allData?.coupon}</div>
                  <Link
                    to="/admin/coupon-list"
                    className="saw-indicator__caption"
                  >
            ...
            <div className="col-12 col-md-4 d-flex">
              <div className="card saw-indicator flex-grow-1">
                <div className="sa-widget-header saw-indicator__header">
                  <h2 className="sa-widget-header__title">Total Testimonial</h2>
                  <div className="sa-widget-header__actions">
                    <div className="dropdown">
                      <button
                        type="button"
            ...
            <div className="col-12 col-md-4 d-flex">
              <div className="card saw-indicator flex-grow-1">
                <div className="sa-widget-header saw-indicator__header">
                  <h2 className="sa-widget-header__title">Total Slider</h2>
                  <div className="sa-widget-header__actions">
                    <div className="dropdown">
                      <button
                        type="button"
                ...
                <div className="saw-indicator__body">
                  <div className="saw-indicator__value">{allData?.slider}</div>
                  <Link
                    to="/admin/slider-list"
                    className="saw-indicator__caption"
                  >
