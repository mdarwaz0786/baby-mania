...
const Sidebar = () => {
  ...
  const [testimonial, setTesttimonial] = useState(false);
  ...
  return (
    <>
      <div
        className={
          mobile
            ? "sa-app sa-app--toolbar-fixed sa-app--desktop-sidebar-shown sa-app--mobile-sidebar-shown"
            : "sa-app sa-app--desktop-sidebar-shown sa-app--mobile-sidebar-hidden sa-app--toolbar-fixed"
        }
      >
        <div className="sa-app__sidebar">
          <div className="sa-sidebar">
            <div
              className="sa-sidebar__header"
                ...
                <li className="sa-nav__section">
                  <ul className="sa-nav__menu sa-nav__menu--root">
                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                      <Link to="/admin" className="sa-nav__link">
                    ...
                    <li
                      className={
                        catalog
                          ? "sa-nav__menu-item sa-nav__menu-item--has-icon sa-nav__menu-item--open"
                          : "sa-nav__menu-item sa-nav__menu-item--has-icon"
                      }
                    ...
                    >
                      ...
                      <ul
                        className="sa-nav__menu sa-nav__menu--sub"
                      ...
                      >
                        ...
                        <li className="sa-nav__menu-item">
                          <Link to="/admin/size-list" className="sa-nav__link">
                            <span className="sa-nav__menu-item-padding" />
                            <span
                              className="sa-nav__title"
                              onClick={() => setMobile(!mobile)}
                        ...
                        <li className="sa-nav__menu-item">
                          <Link to="/admin/add-size" className="sa-nav__link">
                            <span className="sa-nav__menu-item-padding" />
                            <span
                              className="sa-nav__title"
                              onClick={() => setMobile(!mobile)}
                        ...
                        <li className="sa-nav__menu-item">
                          <Link to="/admin/color-list" className="sa-nav__link">
                            <span className="sa-nav__menu-item-padding" />
                            <span
                              className="sa-nav__title"
                              onClick={() => setMobile(!mobile)}
                        ...
                        <li className="sa-nav__menu-item">
                          <Link to="/admin/add-color" className="sa-nav__link">
                            <span className="sa-nav__menu-item-padding" />
                            <span
                              className="sa-nav__title"
                              onClick={() => setMobile(!mobile)}
                    ...
                    >
                      ...
                      >
                        <li className="sa-nav__menu-item">
                          <Link to="/admin/order-list" className="sa-nav__link">
                            <span className="sa-nav__menu-item-padding" />
                            <span
                              className="sa-nav__title"
                              onClick={() => setMobile(!mobile)}
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="sa-nav__title">Contact Enquiry</span>
                        <span className="sa-nav__arrow">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={6}
                    ...
                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                      <Link to="/admin/newsletter" className="sa-nav__link">
                        <span className="sa-nav__icon">
                    ...
                    >
                      ...
                      >
                        ...
                        <li className="sa-nav__menu-item">
                          <Link to="/admin/add-coupon" className="sa-nav__link">
                            <span className="sa-nav__menu-item-padding" />
                            <span
                              className="sa-nav__title"
                              onClick={() => setMobile(!mobile)}
                    ...
                    <li
                      ...
                      data-sa-collapse-item="sa-nav__menu-item--open"
                      onClick={() => setTesttimonial(!testimonial)}
                    >
                      <Link
                        to="#"
                        className="sa-nav__link"
                      ...
                      >
                        ...
                        <span className="sa-nav__title">Testimonial</span>
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="sa-nav__title">Slider</span>
                      ...
                      >
                        ...
                        <li className="sa-nav__menu-item">
                          <Link to="/admin/add-slider" className="sa-nav__link">
                            <span className="sa-nav__menu-item-padding" />
                            <span
                              className="sa-nav__title"
                              onClick={() => setMobile(!mobile)}
              ...
              <div className="dropdown sa-toolbar__item">
                ...
                >
                  <span className="sa-toolbar-user__avatar sa-symbol sa-symbol--shape--rounded">
                    <img src={userIcon} width={64} height={64} alt />
                  </span>
                  <span className="sa-toolbar-user__info">
                    <span className="sa-toolbar-user__title">{user?.name}</span>
                  </span>
                </button>
                <ul
