        ...
        <div className="col-md-6 mb-4">
          <div className="banner banner-fixed category-banner-2 br-xs">
            ...
            <div className="banner-content y-50 pt-1">
              ...
              <h3 className="banner-title font-weight-bolder text-capitalize">Womens Lifestyle Collection</h3>
        ...
        <div className="col-md-6 mb-4">
          <div className="banner banner-fixed br-xs">
            ...
            <div className="banner-content y-50 mt-0">
              ...
              <h3 className="banner-title text-white text-uppercase">Accessories<span className="font-weight-normal text-capitalize"> Collection</span></h3>
          ...
          <div className="main-content">
            <nav className="toolbox sticky-toolbox sticky-content fix-top" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div className="toolbox-left">
                <a href="#" className="btn btn-primary btn-outline btn-rounded left-sidebar-toggle btn-icon-left d-block d-lg-none"><i className="w-icon-category" /><span>Filters</span></a>
            ...
            <div className="product-wrapper row" style={{ marginTop: "2rem" }}>
              {
                products.filter((product) =>
                  product.size.some((size) => size._id === id) ||
                  product.color.some((color) => color._id === id) ||
