...
const SingleProduct = () => {
  ...
  const handleColorSelect = (colorId, imageUrl) => {
    setSelectedColor((prevSelectedColor) =>
      prevSelectedColor === colorId ? null : colorId
    );
    setSelectedImage("");
  ...
  const handleSizeSelect = (sizeId) => {
    setSelectedSize((prevSelectedSize) =>
      prevSelectedSize === sizeId ? null : sizeId
    );
  };
      ...
      <div className="page-content">
        <div className="container">
                ...
                <div className="col-md-6 mb-4 mb-md-6">
                  ...
                  >
                    ...
                    <div className="ratings-container">
                      ...
                      <Link to="#" className="rating-reviews scroll-to">
                            ...
                            {products?.items?.map((item) =>
                              item?.color?.map((color) => (
                                <Link
                                  ...
                                  to="#"
                                  className={`color ${
                                    selectedColor === color?._id ? "active" : ""
                                  }`}
                                  style={{ backgroundColor: color?.colorCode }}
                                  onClick={() =>
                                    handleColorSelect(color?._id, item?.image)
                                  }
                                />
                              ))
                            )}
                ...
                <div className="sticky-sidebar">
                  ...
                  <div className="widget widget-banner mb-9">
                    <div className="banner banner-fixed br-sm">
                      <figure>
                        <Link to="/product" onClick={smoothScrollToTop}>
                          <img
                            src={banner}
                            alt="Banner"
          ...
          <div className="row cols-xl-5 cols-md-4 cols-sm-3 cols-2">
            {relatedProducts
              ?.filter((product) => product?.status === "Show")
              ?.map((product) => (
                <div className="product-wrap" key={product?._id}>
                  <div className="product text-center">
                    <figure className="product-media">
                      <Link
                        to={`/product/single-product/${product?._id}`}
