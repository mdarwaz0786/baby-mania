...
const Department = () => {
  ...
  return (
    <>
      <h4 className="text-center mt-5 mb-3" style={{ paddingTop: "4rem" }}>
        Popular Department
      </h4>
      <div className="container">
        <div
          className="nav nav-tabs justify-content-center mb-1"
          style={{ borderBottom: "none", paddingBottom: "1rem" }}
        >
          <li className="nav-item mr-2 mb-2">
            <button
              ...
              style={{
                cursor: "pointer",
                border: activeTab === "tab1" ? "1px solid black" : "none",
              }}
          ...
          <li className="nav-item mr-2 mb-2">
            <button
              ...
              style={{
                cursor: "pointer",
                border: activeTab === "tab2" ? "1px solid black" : "none",
              }}
          ...
          <li className="nav-item mr-2 mb-2">
            <button
              ...
              style={{
                cursor: "pointer",
                border: activeTab === "tab3" ? "1px solid black" : "none",
              }}
        ...
        <div style={{ display: activeTab === "tab1" ? "block" : "none" }}>
          <div className="row cols-xl-5 cols-md-4 cols-sm-3 cols-2">
            {products
              ?.filter(
                (product) =>
                  product?.status === "Show" && product?.newProduct === "Yes"
              )
              ?.map((product) => {
                return (
          ...
          <div className="row cols-xl-5 cols-md-4 cols-sm-3 cols-2">
            {products
              ?.filter(
                (product) =>
                  product?.status === "Show" &&
                  product?.bestSellingProduct === "Yes"
              )
              ?.map((product) => {
                return (
                  <div className="product-wrap" key={product?._id}>
